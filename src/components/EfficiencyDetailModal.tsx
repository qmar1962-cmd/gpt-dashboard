                  ...
                  >
                    ...
                    {day.abnormalCount > 0 ? (
                      <div className="space-y-0">
                        {/* 表头 */}
                        <div className="grid grid-cols-[1fr_auto_auto_auto_auto_auto] gap-x-3 px-3 py-2 bg-[#f0ebe3] rounded-t-md border-b border-[#e8e2d9]">
                        ...
                        {day.details.map((detail, idx) => (
                          <div
                            key={idx}
                            className={cn(
                              "grid grid-cols-[1fr_auto_auto_auto_auto_auto] gap-x-3 items-center bg-[#faf7f2] px-3 py-2.5 border-b border-slate-50 last:border-0"
                            )}
                          >
                            {/* 岗位名称 */}
